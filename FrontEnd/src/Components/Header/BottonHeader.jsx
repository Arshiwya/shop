...
export default function BottonHeader() {
  ...
  return (
    <>
      <div className="hidden h-11 w-full dark:bg-white child:dark:text-white bg-neutral-800 transition-transform duration-300 lg:flex ">
        <div className="container relative flex items-center justify-start">
          <ul className="hidden h-full items-stretch text-sm font-medium text-white lg:flex [&>li]:px-3 dark:text-black child-hover:text-pink-700">
