    ...
    <>
      <div className="container mt-7 [&>*:last-child]:pl-3 lg:[&>*:last-child]:pl-1">
        <div className="min-w-fit max-w-fit px-0">
          <div className="flex h-full flex-col gap-2 rounded border border-border-gray-light bg-surface-solid-0 p-2 shadow-sm min-h-[248px] !w-[164px] lg:min-h-[280px] lg:!w-[224px]">
            <div class="flex mx-auto grow flex-col gap-1">
              ...
              <span class="font-Dana lg:text-body-14 text-gray-500">پرایم</span>
              <h3 class="line-clamp-2 text-caption-12 font-Dana lg:text-body-14">
            ...
            >
              <div class="flex flex-col items-center text-caption-12 lg:text-body-14">
