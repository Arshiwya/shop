    ...
    <>
      <div className="container pr-7 w-full ">
        ...
        <div>
          {/* Boxs */}
          <div>
            <span className="font-Dana text-xl text-pink-500">
              ضمانت خانومی
            </span>
          ...
          <div>
            <h1 className="font-Dana text-xl mt-7 text-pink-500">ثبت سفارش</h1>
            <div className="divide-y divide-solid">
              <Box
          ...
          <div>
            <h1 className="font-Dana text-xl mt-7 text-pink-500">
              جعبه صورتی و شانس{" "}
            </h1>
            <div className="divide-y divide-solid">
              <Box
